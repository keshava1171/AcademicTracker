    ...
    <script>
        $(document).ready(function() {
            $('#class_id').change(function() {
                ...
                $('#student-scores-list').html('<div class="text-center text-muted">Please select a subject and click \'Load Students & Scores\'.</div>');
            ...
            $('#load-students-btn').click(function() {
                ...
                const testName = $('#test_name_select').val();
                ...
                $.ajax({
                    url: 'ajax_get_students_for_grades.php',
                    type: 'GET',
                    data: { 
                        class_id: classId,
